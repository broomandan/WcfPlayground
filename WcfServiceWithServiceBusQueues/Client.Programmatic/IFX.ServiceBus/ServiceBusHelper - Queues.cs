...
namespace Client.Programmatic.IFX.ServiceBus
{
    static partial class ServiceBusHelper
    {
        public static void CreateQueue(Uri queueAddress, string secret, bool requiresSession = false)
        {
            ...
            CreateQueue(baseAddress, queueName, DefaultIssuer, secret, requiresSession);
        }
        ...
        public static void CreateQueue(Uri baseAddress, string queueName, string issuer, string secret,
        ...
        private static void CreateQueue(Uri baseAddress, string queueName, TokenProvider credentials,
            bool requiresSession = false)
        {
        ...
        private static void CreateQueue(Uri baseAddress, string queueName, QueueDescription queueDescription,
        ...
        public static void DeleteQueue(Uri queueAddress, string secret)
        {
            ...
            DeleteQueue(baseAddress, queueName, DefaultIssuer, secret);
        }
        ...
        {
            VerifyQueue(queueAddress, DefaultIssuer, secret, requiresSession);
        }
        ...
        public static void VerifyQueue(Uri baseAddress, string queueName, string issuer, string secret,
            bool requiresSession = false)
        {
            TokenProvider credentials = TokenProvider.CreateSharedSecretTokenProvider(issuer, secret);
        ...
        {
            PurgeQueue(baseAddress, queueName, DefaultIssuer, secret);
        }
        ...
        private static void DeleteQueue(Uri baseAddress, string queueName, TokenProvider credentials)
        {
        ...
        internal static QueueDescription CreateQueueDescription(string queueName, bool requiresSession = false)
        {
        ...
        internal static void VerifyQueue(Uri baseAddress, string queueName, TokenProvider credential,
            bool requiresSession = false)
        {
        ...
        private static bool QueueExists(Uri baseAddress, string queueName, TokenProvider credentials,bool requiresSession = false)
        {
            var namespaceClient = new NamespaceManager(baseAddress, credentials);

            return namespaceClient.QueueExists(queueName);
        }
